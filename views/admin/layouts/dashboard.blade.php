            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        @if ( Auth::user()->role->name == 'Admin' )
                            <li >
                                <a href="#"><i class="fa fa-picture-o fa-fw"></i>{{ trans("blogify::navigation.Slide.title") }}<span class="fa arrow"></span></a>
                                <ul class="nav nav-second-level">
                                    <li>
                                        <a href="{{ route ('admin.slide.new') }}"><span class="fa fa-plus fa-fw"></span> {{ trans("blogify::navigation.Slide.new") }}</a>
                                    </li>
                                    <li>
                                        <a href="{{ route ('admin.slide.see') }}"><span class="fa fa-th-list fa-fw"></span> {{ trans("blogify::navigation.Slide.overview") }}</a>
                                    </li>
                                </ul>
                                <!-- /.nav-second-level -->
                            </li>
